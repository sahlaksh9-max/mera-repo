...
const AuthSignup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-royal via-royal/90 to-gold/20 flex items-center justify-center p-2 sm:p-4">
      ...
      >
        <div className="bg-card/95 backdrop-blur-md rounded-xl shadow-2xl border border-border/50 p-5">
          {/* Header */}
          <div className="relative">
            ...
            <Button
              ...
              size="sm"
              onClick={() => navigate(-1)}
              className="absolute -top-1 -left-1 text-muted-foreground hover:text-foreground hover:bg-gold/10 transition-all touch-manipulation"
            >
            ...
            <div className="text-center mb-5">
              <motion.div
                ...
                className="w-14 h-14 rounded-full bg-gradient-to-r from-gold to-yellow-500 flex items-center justify-center mx-auto mb-2"
              >
                <IdCard className="h-7 w-7 text-black" />
              </motion.div>
          ...
          {!userType && (
            ...
            >
              ...
              <Button
                ...
                className="w-full h-12 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white touch-manipulation"
              >
                <div className="flex items-center space-x-2">
                  <GraduationCap className="h-5 w-5 flex-shrink-0" />
                  <div className="text-left">
                    <div className="text-sm font-semibold">Student</div>
                    <div className="text-xs opacity-90">Access student portal</div>
                  </div>
                </div>
              </Button>
              ...
              <Button
                ...
                className="w-full h-12 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white touch-manipulation"
              >
                <div className="flex items-center space-x-2">
                  <Users className="h-5 w-5 flex-shrink-0" />
                  <div className="text-left">
                    <div className="text-sm font-semibold">Teacher</div>
                    <div className="text-xs opacity-90">Access teacher portal</div>
                  </div>
                </div>
              </Button>
          ...
          {userType && (
            ...
            >
              ...
              <Button
                variant="ghost"
                onClick={resetForm}
                className="mb-3 text-muted-foreground hover:text-foreground text-sm touch-manipulation"
              >
                ← Back to role selection
              </Button>

              {/* Role Header */}
              <div className="flex items-center space-x-2 mb-4 p-2 bg-muted/20 rounded-lg">
                {userType === "student" ? (
              ...
              <form onSubmit={handleSignup} className="space-y-3">
                ...
                {userType === "teacher" && (
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        <label className="text-xs font-medium text-foreground">Assigned Class *</label>
                        <select
                          value={formData.class}
                          onChange={(e) => setFormData({...formData, class: e.target.value})}
                          className="w-full p-2 border border-border rounded-lg bg-background text-sm"
                      ...
                      <div className="space-y-1">
                        <label className="text-xs font-medium text-foreground">Assigned Section *</label>
                        <select
                          value={formData.section}
                          onChange={(e) => setFormData({...formData, section: e.target.value})}
                          className="w-full p-2 border border-border rounded-lg bg-background text-sm"
                ...
                {userType === "teacher" && (
                  <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                    <div className="flex items-center space-x-2 mb-1">
                      ...
                      <h4 className="text-xs font-semibold text-blue-400">Password Tips</h4>
                    </div>
                    <p className="text-xs text-muted-foreground">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-gold to-yellow-500 hover:from-gold/80 hover:to-yellow-500/80 text-black hover:text-black font-semibold py-2 h-10"
                >
                  {isLoading ? (
                    <div className="flex items-center space-x-2">
